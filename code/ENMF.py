...
def parse_args():
    ...
    parser.add_argument('--embed_size', type=int, default=160,
                        help='Embedding size.')
...
if __name__ == '__main__':
    ...
    tp_test = load_data(os.path.join(DATA_ROOT, 'mltest.txt'))
    tp_train = load_data(os.path.join(DATA_ROOT, 'mltrain.txt'))
